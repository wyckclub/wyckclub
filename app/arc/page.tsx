...
export default function ArcTrackerPage() {
  ...
  return (
    <div className="flex-1 min-w-0 h-full overflow-y-auto px-4 py-3">
      <h2 className="text-2xl font-bold text-blue-400 mb-4">WYCK Arc Tracker</h2>
                  ...
                  return (
                    <tr key={t.CA} className="border-t border-slate-800">
                      ...
                      <td className="p-3 font-semibold whitespace-nowrap">
                        <Link href={`/arc/${t.CA}`} className="text-blue-400 hover:text-blue-300">
                      ...
                      <td className="p-3 whitespace-nowrap">
                        <a
                          href={`https://dexscreener.com/arc/${t.CA}`}
                          target="_blank"
